...
"[project]/node_modules/jose/dist/node/esm/util/base64url.js [middleware] (ecmascript) <export * as base64url>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "base64url",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__
]);
...
// @ts-ignore
const node_fetch_1 = tslib_1.__importDefault(__turbopack_context__.r("[project]/node_modules/@supabase/node-fetch/lib/index.js [middleware] (ecmascript)"));
...
"[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__ = __turbopack_context__.i("[project]/node_modules/jose/dist/node/esm/util/base64url.js [middleware] (ecmascript) <export * as base64url>");
// src/createClient.ts
...
function parseSupabaseCookie(str) {
    ...
    try {
        ...
        const payload = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$node$2f$esm$2f$util$2f$base64url$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__base64url$3e$__["base64url"].decode(payloadStr);
        const decoder = new TextDecoder();
...
function createSupabaseClient(supabaseUrl, supabaseKey, options) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey, {
        ...options,
        auth: {
            flowType: "pkce",
...
"[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@supabase/auth-helpers-nextjs/dist/index.js [middleware] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_auth_helpers_shared = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)");
var supabase;
function createClientComponentClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)");
var import_set_cookie_parser = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware] (ecmascript)");
...
function createPagesServerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)");
var import_set_cookie_parser2 = __turbopack_context__.r("[project]/node_modules/set-cookie-parser/lib/set-cookie.js [middleware] (ecmascript)");
...
function createMiddlewareClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)");
...
function createServerComponentClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __turbopack_context__.r("[project]/node_modules/@supabase/auth-helpers-shared/dist/index.mjs [middleware] (ecmascript)");
...
function createRouteHandlerClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = ("TURBOPACK compile-time value", "https://fwmakeazbshawabsqeea.supabase.co"), supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ3bWFrZWF6YnNoYXdhYnNxZWVhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjA5MDg5NDEsImV4cCI6MjA3NjQ4NDk0MX0.TtCa7LLNz6xXtjFg7ZHWJd_xAHL4EBi8AdolrBfQGRE"), options, cookieOptions } = {}) {
...
//# sourceMappingURL=node_modules_f7c653a8._.js.map