...
export default function AdminSidebar() {
  ...
  const navItems = [
    ...
    { href: "/admin/protected/flagged", label: "Flagged Reviews" },
    { href: "/admin/protected/status", label: "System Status" },
  ...
  return (
    <aside className="w-64 bg-white border-r h-screen flex flex-col p-6">
      {/* Logo */}
      <Link href="/admin" className="text-xl font-semibold mb-8">
        Admin Panel
      </Link>

      {/* New Club Button */}
      <Link
        href="/admin/protected/clubs/new"
